 ...
 * Return: bytes read
 */
ssize_t input_buf(info_f *info, char **buf, size_t *len)
{
	ssize_t r = 0;
	size_t len_p = 0;
...
/**
 * get_input - gets a line minus in the newline
 * @info: parameter struct
 *
 * Return: bytes read
 */
ssize_t get_input(info_f *info)
{
 ...
 * Return: r
 */
ssize_t read_buf(info_f *info, char *buf, size_t *i)
{
	ssize_t r = 0;
 ...
 * Return: s
 */
int _getline(info_f *info, char **ptr, size_t *length)
{
